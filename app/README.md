...
#### TO-DO
- ## 오픈베타
1. User 사이즈 정보 서버로 주고 받기, 서버로부터 사이즈에 맞는 옷만 가져오기 ⭐⭐⭐⭐⭐
2. 애플, 카카오 SDK 붙이기 ⇒ 현재 카카오, 네이버는 WebView로 했으나 수정해야함 ⭐⭐⭐⭐⭐
3. 배치고사 만들기 ⭐⭐⭐⭐⭐
4. Swipe Card UI 코드 다시짜기 (이전거 클릭하면 이전 이미지 보여줘야 함) ⭐⭐⭐⭐
5. 디자인 입히기 ⭐⭐⭐⭐
6. 배포할 때 여러 준비물 준비하기 ⭐⭐⭐⭐
7. 로그아웃하면 서비스 모델 비워주기 ⭐⭐⭐⭐
8. 파이어베이스, 애널리틱스 붙이기 ⇒ 어느정도 붙임. ⭐⭐⭐
9. Swipe Card Service 코드에서 지나간 카드들 배열에서 없애주기 ⭐⭐
10. DressRoom 폴더 기능 완성  ⭐⭐
11. FCM 붙이기 ⭐⭐
12. 튜토리얼 만들기 ⭐⭐
