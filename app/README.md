...
9/6 ~ 9/8 3. 배치고사 만들기 ⭐⭐⭐⭐⭐
9/4 ~ 9/6 4. Swipe Card UI 코드 다시짜기 (이전거 클릭하면 이전 이미지 보여줘야 함) ⭐⭐⭐⭐
9/6 ~ 9/8 5. 디자인 입히기 ⭐⭐⭐⭐
9/9 6. 배포할 때 여러 준비물 준비하기 ⭐⭐⭐⭐
[ALMOST] 9/3 7. 로그아웃하면 서비스 모델 비워주기 ⭐⭐⭐⭐
[ALMOST] 8. 파이어베이스, 애널리틱스 붙이기 ⇒ 어느정도 붙임. ⭐⭐⭐
9/8 9. Swipe Card Service 코드에서 지나간 카드들 배열에서 없애주기 ⭐⭐
[ALMOST] 10. DressRoom 폴더 기능 완성  ⭐⭐
[ALMOST] 11. FCM 붙이기 ⭐⭐
9/5 13. 마이페이지에서 사이즈 수정하기 ⭐⭐⭐⭐
12. 튜토리얼 만들기 ⭐⭐
13. 드레스룸/룩북에 아무 아이템도 없으면 아이템 추가하라는 메세지 띄우기 ⭐⭐⭐


//
해당 버전 application kill switch
파이어베이스에서 버전 바꾸면 못돌아가게끔해야함
애플로그인 넣어야 함
베타 버전을 막아야 함
파이어베이스에 파라미터 읽어가는걸 세팅 close 
안내 메세지 하나 띄워 놓기
버전이 더 이상 작성하지 않습니다!
피드백 받기
