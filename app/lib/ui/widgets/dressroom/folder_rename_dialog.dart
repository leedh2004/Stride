...
class FolderRenameDialog extends StatefulWidget {
  DressRoomModel model;
  FolderRenameDialog(this.model);
  @override
  _FolderRenameDialogState createState() => _FolderRenameDialogState();
}

class _FolderRenameDialogState extends State<FolderRenameDialog> {
