...
class LookBookFolderCreateDialog extends StatefulWidget {
  LookBookModel model;
  LookBookFolderCreateDialog(this.model);
  @override
  _LookBookFolderCreateDialogState createState() =>
      _LookBookFolderCreateDialogState();
}

class _LookBookFolderCreateDialogState
    extends State<LookBookFolderCreateDialog> {
