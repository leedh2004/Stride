...
class LookBookFolderRenameDialog extends StatefulWidget {
  LookBookModel model;
  LookBookFolderRenameDialog(this.model);
  @override
  _LookBookFolderRenameDialogState createState() =>
      _LookBookFolderRenameDialogState();
}

class _LookBookFolderRenameDialogState
    extends State<LookBookFolderRenameDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    curFolderId = widget.model.current_folder;
            ...
            children: [
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration:
                      InputDecoration.collapsed(hintText: "폴더 이름을 입력하세요."),
                ),
              ),
              SizedBox(
                height: 16,
